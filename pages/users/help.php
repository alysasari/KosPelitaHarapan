...
<body class="bg-gray-100 font-sans">   
    ...
    <div class="p-10 w-full ml-[16rem]" data-aos="fade-right">
        <div class="flex-1 bg-white p-6 rounded-lg shadow-lg">
            ...
            <div id="chat-box" class="flex flex-col p-4 h-[400px] overflow-y-auto border rounded-lg bg-gray-50 mb-4">
            </div>
            <div class="flex">
        ...
        function fetchMessages() {
            fetch("pages/controller/get_messages.php")
                ...
                .then(data => {
                    ...
                    data.forEach(msg => {
                        const sender = msg.sender.trim().toLowerCase(); // fix penting
                        const bubble = document.createElement("div");

                        bubble.className = `my-1 p-3 rounded-lg max-w-[70%] ${sender === 'admin'
                                ? 'bg-gray-200 self-start'
                                : 'bg-[#322A7D] text-white self-end ml-auto'
                            }`;
