    ...
    <div class="relative">
        ...
        <div class="container mx-auto grid grid-cols-2 justify-center items-center p-28 relative" data-aos="fade-up">
            ...
            <div>
                ...
                <br>
                <button type="button" class="focus:outline-none text-white bg-[#F1A501] hover:bg-[#F1A501] focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-[#F1A501]  dark:hover:bg-[#F1A501] dark:focus:ring-green-800">Find Out More</button>
            </div>
